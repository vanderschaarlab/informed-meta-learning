...
class SetTrendingSinusoidPrompts():
    ...
    def fprompt_base(train_data, train_knowledge, context_data, knowledge, x):
        prompt = f"You are an expert in predictiing numerical values based on previously observed data."
    ...
    def fprompt_knowledge(train_data, train_knowledge, context_data, knowledge, x):
        ...
        prompt = f"You are an expert in predictiing numerical values based on previously observed data and additional knowledge."
    ...
    @staticmethod
    def fprompt_train_data_knowledge(train_data, train_knowledge, context_data, knowledge, x):
        x_train, y_train = train_data
        x_context, y_context = context_data
