...
def main():
    ...
    parser.add_argument('--sort-context', type=str2bool, const=True, nargs='?', help='Sort context', default=False)
    ...
    parser.add_argument('--knowledge-type', type=str, help='Knowledge type', default='none')
    parser.add_argument('--min-num-context', type=int, help='Minimum number of context', default=0)
    parser.add_argument('--max-num-context', type=int, help='Maximum number of context', default=100)
    ...
    parser.add_argument('--text-encoder', type=str, help='Text encoder', default='none', choices=['simple', 'none', 'roberta', 'set', 'set2', 'mlp'])
    parser.add_argument('--freeze-llm', type=str2bool, const=True, nargs='?', help='Freeze LLM', default=True)
    parser.add_argument('--tune-llm-layer-norms', type=str2bool, const=True, nargs='?', help='Tune LLM layer norms', default=False)
    parser.add_argument('--train-num-z-samples', type=int, help='Number of training z samples', default=1)
    parser.add_argument('--test-num-z-samples', type=int, help='Number of testing z samples', default=16)
